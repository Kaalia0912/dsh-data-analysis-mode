...
- `skills/data-analysis/`、`skills/pandas-3x/`、`skills/xlsx-tools/`（含 `scripts/recalc_excel.py`：Excel COM 公式重算，替代 LibreOffice 依赖）、`skills/visualization/`、`skills/database-connect/`、`skills/statistical-modeling/`
- `scripts/install.ps1`
